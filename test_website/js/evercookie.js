  ...
  function Evercookie(options) {
    ...
    this.evercookie_auth = function (name, value) {
      if (value !== undefined) {
        ...
        newImage('//' + value + ':trashpassword@' + location.host + _ec_baseurl + _ec_phpuri + opts.authPath);
        // popup.blur();
        // window.focus();
      }
      else {
        self.ajax({
          ...
          url: _ec_baseurl + _ec_phpuri + opts.authPath,
          success: function (data) {
            document.cookie = opts.authCookieName + "=" + value + "; expires=Tue, 31 Dec 2030 00:00:00 UTC; path=/; domain=" + _ec_domain;
